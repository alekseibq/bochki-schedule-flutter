...
- реальные справочники `Ассистенты` и `Участники`,
...
- Справочники `Ассистенты` и `Участники` физически хранятся в общем collection `humans`; роль записи определяется флагами `isAssistant` и `isParticipant`.
