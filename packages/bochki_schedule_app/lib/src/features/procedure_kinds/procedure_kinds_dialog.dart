          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(child: Text('t участника')),
                Expanded(child: Text('t ассистента')),
                Expanded(child: Text('t ресурса')),
                SizedBox(width: 72, child: Text('Изм.')),
                SizedBox(width: 72, child: Text('Удл.')),
              ],
            ),
          ),
          Expanded(
